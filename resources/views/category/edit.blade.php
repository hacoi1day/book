    ...
    <div class="container list-category my-3">
        <div class="row">
            ...
            <div class="col-6">
                <div class="row">
                    <div class="col-12 text-center">
                        <h3>sửa danh mục {{ $categoryEdit['name'] }}</h3>
                    </div>
                    @if(session('mess'))
                        <div class="col-12">
                    ...
                    <div class="col-12">
                        <form action="{{ route('category.update', ['id' => $categoryEdit['id']]) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('name') ? "is-invalid" : "" }}" id="name" name="name" placeholder="name category" value="{{ $categoryEdit['name'] }}">
                                @if($errors->has('name'))
